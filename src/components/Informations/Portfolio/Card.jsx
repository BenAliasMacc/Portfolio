        ...
        <div className="rounded-lg p-6 dark:border-[2px] border-[#212425] mb-6">            
            <div className="relative overflow-hidden rounded-lg">
                <div className="overlay" >
                    <a href={link} className="border-solid-white border-2 rounded-2xl text-white text-center mb-3 w-4/5">Site Web</a>
                    <a href={githubLink} className="border-solid-white border-2 rounded-2xl text-white text-center mb-3 w-4/5">Github</a>
                </div>
                <img src={img} alt="" className="w-full h-48 object-fill rounded-md p-px" />
            </div>
