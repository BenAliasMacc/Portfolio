        ...
        <div className="container py-12 mb-8 px-4 sm:px-5 md:px-10 lg:px-[60px]">
            <div>
                ...
                <div className='dark:border-[#212425] dark:border-2 md:p-[48px]  p-4   bg-color-810 rounded-xl dark:bg-[#111111]'>
                    ...
                    <form name="contact" id='contact-form' method='post' data-netlify="true" action='/' >
                        ...
                        <div className='relative z-0 w-full mb-8 group'>
                            ...
                            <label htmlFor="" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-color-910 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-[#5185D4] peer-focus:dark:text-[#FF6464] peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-8">Email *</label>
                        </div>
                        <div className='relative z-0 w-full mb-8 group'>
