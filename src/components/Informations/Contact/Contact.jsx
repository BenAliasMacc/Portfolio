                ...
                <div className='dark:border-[#212425] dark:border-2 md:p-[48px]  p-4   bg-color-810 rounded-xl dark:bg-[#111111]'>
                    ...
                    <form>
                        <div className='relative z-0 w-full mt-[40px] mb-8 group'>
                            <input type="text" className='block autofill:bg-transparent py-2.5 px-0 w-full text-sm text-gray-lite bg-transparent border-0 border-b-[2px] border-[#B5B5B5] appearance-none dark:text-white dark:border-[#333333] dark:focus:border-[#FF6464] focus:outline-none focus:ring-0 focus:border-[#FF6464] peer' />
                        ...
                        <div className='relative z-0 w-full mb-8 group'>
                            <input type="text" className='block autofill:text-red-900 needed py-2.5 px-0 w-full text-sm text-gray-lite bg-transparent border-0 border-b-[2px] border-[#B5B5B5] appearance-none dark:text-white dark:border-[#333333] dark:focus:border-[#FF6464] focus:outline-none focus:ring-0 focus:border-[#5185D4] peer' />
                        ...
                        <div className='relative z-0 w-full mb-8 group'>
                            <input type="text" className='block autofill:bg-yellow-200 py-2.5 px-0 w-full text-sm text-gray-lite bg-transparent border-0 border-b-[2px] border-[#B5B5B5] appearance-none dark:text-white dark:border-[#333333] dark:focus:border-[#FF6464] focus:outline-none focus:ring-0 focus:border-[#CA56F2] peer' />
